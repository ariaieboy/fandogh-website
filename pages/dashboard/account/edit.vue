    ...
    <div class="row">
        <div class="col-xs-12" :class="{'col-md-9':openSidebar , 'col-md-6':!openSidebar}">
            ...
            <div class="fandogh-form-group margin-top-100">
                <f-button v-if="!loadingProgress" @onClick="saveEdit" style="margin-top: 24px" styles="green block">ویرایش</f-button>
                <f-button v-if="loadingProgress" styles="blue block">در حال آپدیت ...</f-button>
                <f-button v-if="!loadingProgress" @onClick="accountPassword"  styles="blue block margin-24">تغییر رمز عبور</f-button>
