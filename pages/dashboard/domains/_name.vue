<template>
    <div v-if="domain">
        ...
        <h2 class="title_header" style="margin-top: 32px">آموزش تایید و دخواست SSL دامنه</h2>
        <div style="width: 100%; display: flex; background: #0045ff; padding: 16px; margin-top: 16px">
            <div class="row lang-detail-media-container" style="margin: 0 !important;">
                ...
                <div class="col-lg-3 col-md-3 col-xs-12 col-md-12 lang-menu-container">
                    ...
                    <div v-for="(menu, index) in language_tutorials_model['java']"
                         :key="menu.title"
      ...
      <span class="success-text">تایید شده</span>`,
        ...
        methods: {
            menuItemSelected(index) {
                this.language_tutorials_model['java'].forEach(menu => {
                    menu.selected = false
                });

                this.language_tutorials_model['java'][index].selected = true;
                this.menu_item = this.language_tutorials_model['java'][index];
            },
