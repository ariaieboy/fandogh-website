        ...
        <div class="dashboard-home-panel-chart">
            <div class="row">
                <div class="col-lg-4 col-sm-12 col-xs-12">
                    <f-charts :data="serviceUsage" unit="مگابایت"/>
                </div>
                <div class="col-lg-4 col-sm-12 col-xs-12">
                    <f-charts title="ٰVolume" :data="volumeUsage" unit="گیگابایت"/>
                </div>
            </div>
        </div>
        <div class="row">
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            serviceUsage() {
                const used = this.$store.state.activePlan.current_used_resources.memory_usage;
                const free = this.$store.state.activePlan.quota.memory_limit - used;
                const usage = [free, used];
                return usage;
            },
            volumeUsage() {
                const used = this.$store.state.activePlan.current_used_resources.volume_usage;
