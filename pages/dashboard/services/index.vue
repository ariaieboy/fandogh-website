                    ...
                    <svg width="208px" height="55px" viewBox="0 0 208 63" version="1.1"
                        ...
                        <defs>
                            <filter x="-6.0%" y="-21.8%" width="112.0%" height="143.6%" filterUnits="objectBoundingBox"
                                ...
                                <feColorMatrix
                                        values="0 0 0 0 0.141176471   0 0 0 0 0.835294118   0 0 0 0 0.847058824  0 0 0 0.404692963 0"
                    ...
                    <tr class="data-head" v-for="(service, index) in services">
                        ...
                        <td @click="details(index)" style="cursor: pointer">
                            <div style="display: flex">
                                <canvas
                                        class="state"
                                        style="border-radius: 100px; margin-top: auto; margin-bottom: auto;"
                                        :style="{ backgroundColor: (service.state.toString().toLowerCase() === 'running' ? '#3ccc38' : '#fd3259')}">
                        ...
                        <td class="more-button">
                            <div class="dropdown dropbtn" @click="notify(index)" style="margin: auto; display: flex">
                                ...
                                <div :id="index" class="dropdown-content" :v-model="service">
                                    <a @click="details(index)"><img src="../../../static/icons/ic-logs.svg"
                                                                    alt="detail"/>جزئیات سرویس</a>
                                    <a @click="logs(index)"><img src="../../../static/icons/file.svg" alt="logs"/>‌مشاهده
                                        لاگ‌ها</a>
                                    <a @click="remove(index)" style="color: #fd3259"><img
                                            src="../../../static/icons/ic_delete.svg" alt="remove"/>حذف سرویس</a>
                                </div>
    ...
    export default {
        ...
        data() {
            return {
                isLoading: false,
                titleRow: [
                    {title: 'نام سرویس', width: '40%'},
                    {title: 'حافظه (مگابایت)', width: '15%'},
                    {title: 'تاریخ ساخت', width: '35%'},
                    {title: 'وضعیت', width: '10%'}
                ]
            };
        },
        computed: {
