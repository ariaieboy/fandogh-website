        ...
        <div class="images">
            ...
            <div style="overflow: hidden; margin-bottom: 32px">
                ...
                <div v-if="verifyUserAccess({ADMIN: 'ADMIN', DEVELOPER: 'DEVELOPER'})" class="left"
                    ...
                    <svg width="185px" height="58px" viewBox="0 0 208 63" version="1.1"
                         xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <!-- Generator: Sketch 53.1 (72631) - https://sketchapp.com -->
                        <title>Group 29</title>
                        <desc>Created with Sketch.</desc>
                        <defs>
                            <filter x="-6.2%" y="-23.1%" width="112.4%" height="146.2%" filterUnits="objectBoundingBox"
                                    id="filter-1">
                                <feOffset dx="0" dy="2" in="SourceAlpha" result="shadowOffsetOuter1"></feOffset>
                                <feGaussianBlur stdDeviation="2" in="shadowOffsetOuter1"
                                                result="shadowBlurOuter1"></feGaussianBlur>
                                <feColorMatrix
                                        values="0 0 0 0 0.141176471   0 0 0 0 0.835294118   0 0 0 0 0.847058824  0 0 0 0.356342876 0"
    ...
    export default {
        ...
        data() {
            return {
                ...
                menuList: [],
                menuListComplete: [
                    {method: this.editVolumeCapacity, icon: 'ic-resize.svg', title: 'افزایش فضای ذخیره‌سازی'},
                    {
                        method: this.remove,
                        icon: 'ic_delete.svg',
        ...
        methods: {
            ...
            editVolumeCapacity(index) {
                this.$router.push(`volumes/${this.volumes[index].name}`)
            },
            remove(index) {
                this.$ga.event({
