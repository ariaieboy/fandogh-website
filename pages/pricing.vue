            ...
            return {
                ...
                headers: {
                    plans: {
                        ...
                        title: 'پشتیبانی',
                        icon: 'consulting.svg',
                        description: 'تجربه‌های بسیاری در قلب کارهایی که ما انجام می دهیم وجود دارد و ما این تجربه‌ها را در قالب گزینه های مختلف پشتیبانی در اختیار شما قرار می دهیم تا بتوانید تمام تمرکز خود را در ساخت برنامه های عالی قرار دهید و از مشکلات احتمالی و سردرگمی‌های فنی خلاص شوید.'
                    }
                },
                selected_plan: {
                    index: 0,
                ...
                support_menu_data: [
                    ...
                    },
                    {
                        ...
                        is_en: false,
                        develop: false,
                        professional: `۱۲ ساعت در ماه<br>مجازی`,
                        enterprise: `۲۴ ساعت در ماه<br>مجازی | حضوری`
                    },
                    {
                    ...
                    {
                        title: 'خدمات انتقال داده‌ها',
                        is_en: false,
                        develop: `انتقال داده‌ها از مبدا<br>به سکوی ابری فندق`,
                        professional: `انتقال داده‌ها از مبدا<br>به سکوی ابری فندق`,
                        enterprise: `انتقال داده‌ها از مبدا<br>به سکوی ابری فندق`
                    },
                    {
                        title: 'مشاوره ویدئویی',
                        is_en: false,
                        develop: `به صورت مجازی<br>۲ ساعت در ماه`,
                        professional: `به صورت مجازی<br>۳ ساعت در ماه`,
                        enterprise: `به صورت مجازی<br>۸ ساعت در ماه`
                    },
                    {
                        title: 'مشاوره معماری',
                        is_en: false,
