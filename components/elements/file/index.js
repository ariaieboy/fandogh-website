...
export default {
  ...
  render(h, {props, ...rest}){
    ...
    return <div class="upload-btn-wrapper">
      ...
      <button id={'file'} ref={'file'} style={'border-radius: 25px; padding: 12px 32px; font-family: iran-yekan; border: 1px solid #00E5FF; max-width: 200px; overflow: hidden; text-overflow: ellipsis;'}> Browse </button>
    </div>
  }
}
