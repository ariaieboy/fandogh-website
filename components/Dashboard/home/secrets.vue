            ...
            <div style="margin-left: 12px; margin-right: 12px; margin-top: 12px">
                <table style="width: 100%; border: none; border-collapse: collapse; table-layout: fixed">
                    <tr v-for="(secret, index) in secrets" v-if="index < 5" style="height: 40px; border-collapse: collapse; font-family: iran-yekan;font-size: 0.8em; color: #333333;
                        ...
                        <td :width="headers[1].width" style="text-align: center; font-family: iran-sans; text-overflow: ellipsis; overflow: hidden; white-space: nowrap">{{secret.created_at}}</td>
                        <td :width="headers[2].width" style="text-align: center; padding-left: 6px; padding-right: 6px; text-overflow: ellipsis; overflow: hidden; white-space: nowrap">
                            {{secret.type}}
                        </td>
                    </tr>
                </table>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            createSecret() {
                this.$router.push('/dashboard/secret/create')
            },
        }
    };
</script>
