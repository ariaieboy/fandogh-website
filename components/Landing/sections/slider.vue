            ...
            return {
                ...
                slider_data: [
                    ...
                    },
                    {
                        ...
                        description: 'فندق اولین سکوی ابری عمومی ایران است که تکنولوژی زیرساختی PaaS را در قالبی کاملا ساده و با معماری مخصوص به خود پیاده سازی کرده و سعی بر آن دارد تا با کمک بهترین متخصصین و برنامه‌نویسان سرتاسر جهان به به صنعت ابری و زیرساختی ایران کمک کند.',
                        button_text: "مطالعه بیشتر",
